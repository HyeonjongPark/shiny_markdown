...
output:
  flexdashboard::flex_dashboard:
    theme: paper
    favicon: E:/data-analysis/messy/shiny_markdown/in/ios7-location-outline.png
    source_code: embed
---
...
sch <- readRDS("E:/data-analysis/messy/shiny_markdown/in/gias_sample.RDS")
...
URN", sch$sch_urn, "Phase", sch$sch_phase, "Type", sch$sch_type, "Location", sch$geo_town, ", ", sch$geo_postcode, "LA", sch$geo_la, "
